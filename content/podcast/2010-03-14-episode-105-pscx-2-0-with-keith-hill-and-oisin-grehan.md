...
aliases:
  - /2010/03/episode-105-pscx-2-0-with-keith-hill-and-oisin-grehan/
---
...
Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://media.libsyn.com/media/powerscripting/PSPodcast-105.mp3)
...
- 
  [PSCX user prefs](http://pscx.codeplex.com/sourcecontrol/network/Show?projectName=Pscx&changeSetId=64548#1019270)
...
 
 ...
 [2]: http://www.jonathanmedd.net/2010/03/get-scripting-episode-16-with-hey-scripting-guy-ed-wilson.html "was on Episode 16 of the Get-Scripting podcast"
 [3]: http://chadwickmiller.spaces.live.com/blog/cns!EA42395138308430!946.entry "has a cool new "SQLISE" visual query feature"
 [4]: http://powerwf.com/ "PowerWF.com"
 [5]: http://sapien.com/ "SAPIEN Technologies"
 [6]: http://larryhinz.wordpress.com/2010/03/11/powershell-quickies/ "PowerShell Quickies"
 [7]: http://www.energizedtech.com/2010/03/powershell-unlocking-the-deep.html "Unlocking the Deep Dark Secrets in .NET"
 [8]: http://www.ravichaganti.com/blog/?p=1275&utm_source=feedburner&utm_medium=feed&utm_campaign=Feed:+RavikanthChaganti+(Ravikanth+Chaganti) "Manage VirtualBox with PowerShell"
 [9]: http://powershell.com/cs/blogs/tips/archive/2010/03/08/launching-a-powershell-script-externally.aspx "outside of the console"
 [10]: http://powershell.com/cs/blogs/tips/archive/2010/03/11/creating-large-dummy-files-with-net.aspx "Create a large dummy file"
