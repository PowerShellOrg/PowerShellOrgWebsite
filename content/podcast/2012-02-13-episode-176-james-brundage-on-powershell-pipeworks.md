...
podcast_url: "http://traffic.libsyn.com/powerscripting/PSPodcast-176.mp3"
aliases:
  - /2012/02/episode-176-james-brundage-on-powershell-pipeworks/
---
...
**A Podcast about Windows PowerShell.**
  ...
  **[![](http://powerscripting.libsyn.com/img/podcastIcon.gif)](http://traffic.libsyn.com/powerscripting/PSPodcast-176.mp3)**
...
#### 
 ...
 [http://autobrowse.start-automating.com](http://autobrowse.start-automating.com/) / - IE Automation
    ...
    - 
        ...
        [Update-Web.com (blog about Pipeworks)](http://update-web.com/)
    ...
    - 
        ...
        Pipeworks sites and examples:
            ...
            [Heatmap](http://heatmap.start-automating.com/)
        ...
        - 
            ...
            [SecureSettings](http://securesettings.start-automating.com/)
        ...
        - 
            ...
            [EZOut](http://ezout.start-automating.com/)
        ...
        - 
            ...
            [Show-PowerShell](http://show-powershell.com/)
 ...
 **
    ...
    [21:55:08]  To the cloud!





    [22:01:55]  I feel so disconnected 😉





    [22:02:26]  James has a very similar talking style to Don, atleast that how it sounds to me





    [22:03:45]  Man you guys own a LOT of domains 🙂





    [22:05:06]  fyi Steam has Plants vs. Zombies for 2 bucks.. nice





    [22:05:16]  I love that game
 ...
 **
    ...
    [22:25:21]  ### sorry if this was already addressed.... But do the sites created and that run posh, handle site load as well as sites made the traditional way
 ...
 **
    ...
    [22:27:50]  ## does it multi-thread request handling?





    [22:28:16]  ## does each request run on the same runspace?





    [22:28:25]  ## or is it a new runspace every single time?





    [22:30:29]  ## Do powershell scripters have to choose between learning web design and ending up with sites that look like yours?
 ...
 **
    ...
    [22:34:42]  I just watched that movie "The Social Network"...I picture James writing Pipeworks while drunk in a single evening
 ...
 **
    ...
    [22:36:43] * BSonPosh (~tshell@129.62.91.184.cfl.res.rr.com) has quit IRC (error: Connection reset by peer)





    [22:37:22] * BSonPosh (~tshell@129.62.91.184.cfl.res.rr.com) joins #PowerScriptingPodcast





    [22:38:23]  my internet is flaky





    [22:38:39]  BSonPosh we noticed
