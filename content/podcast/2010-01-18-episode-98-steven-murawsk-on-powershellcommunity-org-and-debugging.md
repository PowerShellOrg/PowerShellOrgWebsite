...
podcast_url: "http://media.libsyn.com/media/powerscripting/PSPodcast-098.mp3"
aliases:
  - /2010/01/episode-98-steven-murawsk-on-powershellcommunity-org-and-debugging/
---
...
Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://media.libsyn.com/media/powerscripting/PSPodcast-098.mp3)
...
*
        ...
        - 
          [New product MobileShell from Quest!](http://dmitrysotnikov.wordpress.com/2010/01/12/mobileshell-powershell-prompt-in-a-browser/?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed:+DmitrysPowerblog+(Dmitry's+PowerBlog))
...
](http://www.amazon.com/gp/product/0321492668?ie=UTF8&tag=techprosaic-20&linkCode=as2&camp=1789&creative=390957&creativeASIN=0321492668)
...
Resources
        ...
        - 
          [Where to start with PowerShell](http://www.jonoble.com/blog/2009/12/18/where-to-start-with-powershell-christmas-2009-edition.html)
        ...
        - 
          [How objects are sent to and from remote sessions](http://blogs.msdn.com/powershell/archive/2010/01/07/how-objects-are-sent-to-and-from-remote-sessions.aspx)


        - 
          [Twitter unfollow with PowerShell](http://www.lancerobinson.net/archive/2010/01/12/powershell-twitter-auto-un-follow.aspx)
...
 
              ...
              - 
                [Using the Sync Framework from PowerShell](http://blog.usepowershell.com/2009/11/using-the-sync-framework-from-powershell/)


              - 
                [Script Injection with Set-PSBreakpoint](http://blog.usepowershell.com/2010/01/script-injection-with-set-psbreakpoint/)
              ...
              - 
                [Watch out for CTRL+BREAK](http://powershell.com/cs/blogs/tips/archive/2010/01/14/dangerous-keystroke.aspx)
              ...
              - 
                [Context-sensitive help on PSProviders from Jeff Hicks](http://jdhitsolutions.com/blog/2010/01/a-smart-psdrive-provider/)


              - 
                [Childproofing PowerShell](http://powershell.com/cs/blogs/tips/archive/2010/01/11/childproofing-powershell.aspx)
