...
podcast_url: "http://media.libsyn.com/media/powerscripting/PSPodcast-046.mp3"
aliases:
  - /2008/10/episode-46-sql-psx/
---
...
*Quest Software is offering Powerscripting Podcast listeners a free copy of Jeffery Hicks new book, Managing Active Directory with Windows PowerShell: TFM from Sapien Press. Visit *[*quest.com/powerscripting*](http://quest.com/powerscripting)* to register for your copy, before they run out. While you"™re there download their free graphical user interface, script editor and Active Directory commands.*
      ...
      - 
        [Working with NetApp in PowerShell](http://get-powershell.com/2008/10/20/working-with-netapp-using-powershell/)


      - 
        [
Another Great Don Jones Video Demo
](http://blogs.msdn.com/powershell/archive/2008/10/22/another-great-don-jones-video-demo.aspx)
...
[Creating Subversion Repositories using PowerShell](http://www.jameskovacs.com/blog/CreatingSubversionRepositoriesUsingPowerShell.aspx)
...
## 
    ...
    - 
      [Using split-path](http://groups.google.com/group/microsoft.public.windows.powershell/browse_thread/thread/13c1729260582eb5)





 [1]: http://media.libsyn.com/media/powerscripting/PSPodcast-046.mp3
