...
podcast_url: "http://media.libsyn.com/media/powerscripting/PSPodcast-030.mp3"
aliases:
  - /2008/06/episode-30-teched-report/
---
...
_Our interview today is brought to you by_ [_Quest Software_][10]_._  
...
_Go to_ [_www.quest.com/powerscripting_][11] _to register for your copy and download their free graphical user interface, script editor and Active Directory commands_.
...
_"Admin Script Editor provides a true integrated scripting environment for PowerShell.  Advanced features include an integrated PowerShell debugger, advanced code generating tools for Active Directory, Databases, XML files and more.  Let's not forget about the exclusive PowerShell forms designer. What's coming up? Soon its innovative and feature-rich ScriptPackger tool will offer support for the dynamic installation of cmdlets! Come see for yourself-- Admin Script Editor v3.5 is availble for a 45 day trial at_ [_AdminScriptEditor.com_][13]_."_
  ...
  * This is from a twitter fan [stahler][15] and his new blog "[FatBeard's Adventures in PowerShell][16]": 
      * [Change DNS & WINS on multiple machines][16] "I was recently asked if I could change the DNS & WINS IP address on multiple servers via script. PowerShell to the rescue!"
  * Jeffery Snover has a post on [getting credentials from the command line][17] -it's a simple registry change
...
Please email us () tips and feedback!  We also love iTunes reviews and blog comments.  Other ways to interact with us: [Facebook Group][24] (forums, networking), Twitter ([jonwalz][25] & [halr9000][26])
 ...
 [3]: http://sdmsoftware.com/group_policy_health.php
 [4]: http://karlprosser.com/coder/2008/06/17/portable-powershell-v1-and-v2-side-by-side-even-on-server-core/
 [5]: http://www.citrix.com/English/ps2/products/product.asp?contentID=1297816
 [6]: http://www.citrix.com/English/ss/downloads/results.asp?productID=1297816
 [7]: http://dmitrysotnikov.wordpress.com/2008/06/13/breakthrough-product-of-teched-2008/
 [8]: http://dmitrysotnikov.wordpress.com/2008/06/20/ocs-management-console-on-steroids/
 [9]: http://blogs.msdn.com/powershell/archive/2008/06/17/when-will-powershell-v2-ship.aspx
 [10]: http://quest.com/powerscripting
 [11]: http://www.quest.com/powerscripting
 [12]: http://www.itripoli.com/
 [13]: http://adminscripteditor.com
 [14]: http://www.adminscripteditor.com/
 [15]: http://twitter.com/stahler
 [16]: http://fatbeards.blogspot.com/
 [17]: http://blogs.msdn.com/powershell/archive/2008/06/20/getting-credentials-from-the-command-line.aspx
 [18]: http://dmitrysotnikov.wordpress.com/
 [19]: http://poshoholic.com/
 [20]: http://poshoholic.com/2008/06/19/book-review-windows-powershell-pocket-reference/
 [21]: http://www.ittv.net/VideoPlayer/tabid/57/VideoId/22/Dmitry-Sotnikov-Discusses-PowerGUI-With-Jeff-James.aspx
 [22]: http://blogs.technet.com/benp/
 [23]: http://www.brianmadden.com/blog/BrianMadden/Conversations-from-the-MVP-Summit-PowerShelling-Citrix-and-Terminal-Server-login-scripts
 [24]: http://www.facebook.com/group.php?gid=7033985478
 [25]: http://twitter.com/jonwalz
 [26]: http://twitter.com/halr9000
