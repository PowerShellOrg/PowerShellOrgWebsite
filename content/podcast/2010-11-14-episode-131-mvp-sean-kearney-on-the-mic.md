...
podcast_url: "http://traffic.libsyn.com/powerscripting/PSPodcast-131.mp3"
aliases:
  - /2010/11/episode-131-mvp-sean-kearney-on-the-mic/
---
...
**A Podcast about Windows PowerShell.**
 Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://traffic.libsyn.com/powerscripting/PSPodcast-131.mp3)
      ...
      Visit [quest.com/powerguipro](http://quest.com/powerguipro) and see why PowerShell and Quest PowerGUI are the ultimate Windows management tools.
        ...
        - 
          Usergroup news! 
              ...
              [NYC Dec 13th](http://powershellgroup.org/content/december-13-2010-brandon-shell-returns), Brandon Shell returns to talk about his PowerShell module
...
**
      ...
      - 
        Sean's blog: [http://www.energizedtech.com/](http://www.energizedtech.com/)
...
from Andrew Kutz
      ...
      - 
        [Quickly install all of Telerik's products with a PowerShell script](http://www.telerikwatch.com/2010/11/quickly-update-all-telerik-product.html)


      - 
        [TechEd 2010 Advanced Automation using PowerShell](http://powershell.com/cs/blogs/tobias/archive/2010/11/07/teched-2010-advanced-automation-using-powershell.aspx)


      - 
        Jeff Hicks presents his "[Kitchen Sink prompt](http://jdhitsolutions.com/blog/2010/10/friday-fun-the-kitchen-sink-prompt/#utm_source=feed&utm_medium=feed&utm_campaign=feed?utm_source=rss&utm_medium=rss&utm_campaign=friday-fun-the-kitchen-sink-prompt)"


      - 
        [PowerShell for Beginners session report](http://powershell.com/cs/blogs/tobias/archive/2010/11/08/teched-powershell-for-beginners.aspx)


      - 
        [Tome shows us how to grab the PID of IE tabs](http://powertoe.wordpress.com/2010/11/10/finding-the-thread-pid-that-belongs-to-a-tab-in-ie-8-with-powershell/)
...
**
      ...
      - 
        Remember, an object is often not reality


      - 
        [Find currently logged on users](http://boeprox.wordpress.com/2010/11/01/quick-hit-find-currently-logged-on-users/)
