...
Morten Mynster is a cybersecurity consultant and an active member of the PowerShell and security community. Over the past year, he's published three PowerShell modules focused on Microsoft Graph permissions and actionable messages in Outlook, discovered and reported a security vulnerability to Microsoft, and begun public speaking. He blogs at [mynster9361.github.io][2] and is active on LinkedIn and Discord.

Resource Links:

  * Andrew's Links: <https://andrewpla.tech/links>
  * PDQ Discord: [discord.gg/PDQ][3]
  * Morten's Blog: [mynster9361.github.io][2]
  * Morten on LinkedIn: <https://www.linkedin.com/in/mortenmynster/>
  * Least Privileged MS Graph Module (GitHub): [github.com/Mynster9361/Least_Privileged_MSGraph][4]
  * Actionable Messages Module (GitHub): [github.com/Mynster9361/ActionableMessages][5]
  * Actionable Messages Module blog post: [mynster9361.github.io/posts/ActionableMessagesModule][6]
  * PowerShell + DevOps Global Summit: [powershellsummit.org][7]
  * PowerShell Conference Europe (PSConfEU): [psconf.eu][8]
  * The PowerShell Podcast on YouTube: <https://youtu.be/VIEbain7IIg>

 [1]: https://mcdn.podbean.com/mf/web/nrwx27zcg3v56e63/The_PowerShell_Podcast_episode_220_Morten_Mynsterbm7s7.mp3
 [2]: http://mynster9361.github.io
 [3]: http://discord.gg/PDQ
 [4]: http://github.com/Mynster9361/Least_Privileged_MSGraph
 [5]: http://github.com/Mynster9361/ActionableMessages
 [6]: http://mynster9361.github.io/posts/ActionableMessagesModule
 [7]: http://powershellsummit.org
 [8]: http://psconf.eu
