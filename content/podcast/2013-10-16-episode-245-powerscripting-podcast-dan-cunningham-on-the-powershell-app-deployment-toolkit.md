...
aliases:
  - /2013/10/episode-245-powerscripting-podcast-dan-cunningham-on-the-powershell-app-deployment-toolkit/
---
...
**A Podcast about Windows PowerShell.**
  ...
  **[![](http://powerscripting.libsyn.com/img/podcastIcon.gif)](http://traffic.libsyn.com/powerscripting/PSPodcast-245.mp3)**
...
- 
    ...
    [http://dcunningham.net/2013/08/07/powershell-app-deployment-toolkit/](http://dcunningham.net/2013/08/07/powershell-app-deployment-toolkit/)
...
#### 
  ...
  <0halr9000> you guys know what to do with the whole ## stuff right?


  <4Vern_Anderson> ## to ask a question


  <4Vern_Anderson> ## is there an app list like chocolety


  <14ScriptingWife> ## did he talk about targeting yet?
  ...
  <6Rich> ## Does the tool inspect MSi files and list which properties can be specified on commandline?


  <6Rich> ## Does the tool inspect MSI files and list which properties can be specified on commandline?


  <6Rich> ## Are there any plans to automate the process of creating the Deploy-Application.ps1 scripts via a GUI, rather than asking the user to modify them by hand?
