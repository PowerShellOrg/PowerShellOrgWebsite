...
aliases:
  - /2009/10/episode-89-powershell-v2-launch-party-with-distinguished-engineer-jeffrey-snover/
---
...
Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://media.libsyn.com/media/powerscripting/PSPodcast-089.mp3)
...
*Don"™t wait "“ visitÂ [quest.com/powershellbook](http://www.quest.com/powershellbook) to register for your free copy and see why PowerShell and Quest Power GUI are the ultimate Windows management tools.*
        ...
        - 
          [Dmitry tells us what's new in PoweGUI v1.9.5](http://dmitrysotnikov.wordpress.com/2009/10/14/whats-new-in-powergui-1-9-5/)


        - 
          [Call for Script Club in Philly](http://powershellcommunity.org/Forums/tabid/54/aff/18/aft/4351/afv/topic/Default.aspx)


        - 
          [http://webmeeting.dimdim.com//webmeeting.dimdim.com/portal/JoinForm.action?confKey=jtruman0917](http://webmeeting.dimdim.com//webmeeting.dimdim.com/portal/JoinForm.action?confKey=jtruman0917) Tuesday 10/27 6:30 EST


        - 
          [SharePoint <3 PowerShell!](http://dmitrysotnikov.wordpress.com/2009/10/19/sharepoint-2010-cmdlet-reference/)
...
#### 
        ...
        - 
          [http://blogs.msdn.com/powershell/archive/2009/08/30/powershell-interview.aspx](http://blogs.msdn.com/powershell/archive/2009/08/30/powershell-interview.aspx)


        - 
          [http://edge.technet.com/Media/PowerShell-Discussions-with-the-Architect-Part-1/](http://edge.technet.com/Media/PowerShell-Discussions-with-the-Architect-Part-1/)


        - 
          [http://pinvoke.net/](http://pinvoke.net/Tonight%20on%20the%20PowerScripting%20Podcast%20we%20talk%20to%20Microsoft%20Distinguished%20Engineer%20Jeffrey%20Snover%20about%20V2%20release%21)
