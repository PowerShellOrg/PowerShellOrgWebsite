...
categories:
  - Announcements
aliases:
  - /2013/07/techsessions-free-powershell-webinars/
---
...
In most cases you will need to _register_ for each one, so that we can send the appropriate invite information. Our sponsors are working with us on these, so each one might be in a different webinar platform (Lync, Webex, etc) depending on who is providing the infrastructure that month.  
In all cases, we'll announce the TechSession in our [TechLetter Newsletter][1], via banners on this site, and in a blog post. You'll notice a new "TechSessions" post category for those announcements.  
