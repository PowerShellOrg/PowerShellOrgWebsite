---
url: /articles/2013-07-01-come-to-powershell-summer-school/
...
categories:
  ...
  - Training
aliases:
  - /2013/07/come-to-powershell-summer-school/
---

Through my company Concentrated Tech, I've decided to run a set of three [PowerShell Summer School][1] classes (click that link for descriptions). These will be a combo of self-study and weekly online sessions, designed to teach Toolmaking, Practical applications of PowerShell, or how to teach PowerShell in a lunch 'n' learn style format. Registration is open from now until August 1st, and you'll also get a discount on some great SAPIEN products to use during class, if you like.  
...
All of these classes assume a basic level of PowerShell knowledge, although you'll get plenty of review material to help you catch up, or dredge up old memories from when you _last_ tried to learn the shell.  
Tell a friend, tell a colleague - I don't do these kinds of offerings all that often; my travel schedule usually precludes it. But a fortuitous schedule has made it possible, so consider taking advantage!
 ...
 [1]: http://itpro.concentratedtech.com/training/summerschool.php
