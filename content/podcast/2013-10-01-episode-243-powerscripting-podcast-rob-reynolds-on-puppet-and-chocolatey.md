...
podcast_url: "http://traffic.libsyn.com/powerscripting/PSPodcast-243.mp3"
aliases:
  - /2013/10/episode-243-powerscripting-podcast-rob-reynolds-on-puppet-and-chocolatey/
---
...
**A Podcast about Windows PowerShell.**
  ...
  **[![](http://powerscripting.libsyn.com/img/podcastIcon.gif)](http://traffic.libsyn.com/powerscripting/PSPodcast-243.mp3)**
...
- 
    ...
    [PowerShell Saturday #006 - Singapore Oct 12th](http://powershellsatsg02.eventbrite.sg/)
...
- 
    ...
    [Ep 199 - Rob Reynolds intro to Chocolatey](https://powershell.org/2012/09/07/episode-199-rob-reynolds-talks-powershell-and-chocolatey/)
...
- 
    ...
    [Vagrant Windows Puppet project](https://github.com/ferventcoder/vagrant-windows-puppet)
...
#### 
  ...
  <14ScriptingWife> ## what is the topic tonight?


  <4Vern_Anderson> ## && Happy Birthday to @ScriptingWife


  <7JimBirley> ## All night long
  ...
  <13Stuwee> ## What does puppet actually do?


  <13Stuwee> ## so will DSC replace puppet?
  ...
  <4Vern_Anderson> ## Normal open sourced customers are on their own


  <11ScriptWarrior> ## So does Puppet consume the MOF Files?


  <4Vern_Anderson> ## Managed Object Format (MOF)
  ...
   [http://youtu.be/liKhLNY5GYI](http://youtu.be/liKhLNY5GYI)  I'm your puppet
   ...
   http://en.wikipedia.org/wiki/Windows_Management_Instrumentation#WMI_tools


   Looking forward to going to Weidmanns for lunch tomorrow: http://www.weidmanns1870.com/
   ...
   http://www.youtube.com/watch?v=qO4yR2l3V1k
   ...
   ScriptingWife | The place I'm having lunch at tomorrow has Praline Cheesecake and Praline Bread Pudding a la mode http://www.weidmanns1870.com/our-menus/lunch-menu/


   http://grooveshark.com/s/Existence+VIP/3LxAuC?src=5


   Here are the books I read last year, http://www.toddklindt.com/blog/Lists/Posts/Post.aspx?ID=383


#### 
  The Question - First Computer


- 
  Gateway Pentium 133, and it was horrible!
