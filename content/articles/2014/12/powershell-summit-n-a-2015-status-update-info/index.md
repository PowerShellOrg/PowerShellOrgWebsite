---
url: /articles/2014-12-15-powershell-summit-n-a-2015-status-update-info/
...
categories:
  ...
  - PowerShell Summit
aliases:
  - /2014/12/powershell-summit-n-a-2015-status-update-info/
---
...
The two rooms are actually in different buildings, separated from each other by a driveway/courtyard arrangement. We're suggesting that you _not_ bring your ginormous 21" laptop, since it'll just drag you down moving between sessions. Maybe stick with a Surface if you want to take notes and stuff. Although we're recording everything, so... you know. Maybe just enjoy the session.  
Lunches will be taken _in the session rooms_, with buffet setups in the hallways just outside each room.  
