...
podcast_url: "http://traffic.libsyn.com/powerscripting/PSPodcast-133.mp3"
aliases:
  - /2010/12/episode-133-shane-hoey-in-australia-is-paging-dr-scripto/
---
...
**A Podcast about Windows PowerShell.**
 Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://traffic.libsyn.com/powerscripting/PSPodcast-133.mp3)
...
#### 
    ...
    - 
      [Paging Dr. Scripto campaign website](http://scriptingguysdownunder.com/)


    - 
      [PowerShell UG Leads on LinkedIn](http://www.linkedin.com/groupsDirectory?itemaction=mclk&anetid=3699075&impid=&pgkey=anet_search_results&actpref=anetsrch_name&trk=anetsrch_name&goback=.gdr_1291345376152_2)
...
**
 This segment brought to you by [ServerFault.com](http://serverfault.com/)
    ...
    - 
      [How Can You Obtain PowerShell Training?](http://halr9000.com/article/911)


    - 
      Thomas Lee has [even more ways to obtain PowerShell training](http://tfl09.blogspot.com/2010/11/powershell-training.html)
    ...
    - 
      Two from PowerShell.com: 


          [Reset a network adapter](http://powershell.com/cs/blogs/tips/archive/2010/11/30/resetting-network-adapters.aspx)


        - 
          [Hide a network adapter](http://powershell.com/cs/blogs/tips/archive/2010/12/01/hiding-network-adapter.aspx)
    ...
    - 
      The [BSonPosh module](http://code.msdn.microsoft.com/bsonposh) also has network adapter functions


    - 
      Mark Mitchell [posted a great writeup](http://designandcode.net/2010/10/09/PowershellScriptedGUI.aspx) with resources from his recent Atlanta PowerShell User group about scripted GUIs in PowerShell
...
**
    ...
    - 
      [Convert a string to Proper Case with PowerShell](http://www.jonoble.com/blog/2010/11/19/converting-a-string-to-proper-case-in-powershell.html)
    ...
    - 
      [](http://www.jonoble.com/blog/2010/11/19/converting-a-string-to-proper-case-in-powershell.html)Remembering the syntax for multi-line comments [just got easier](http://www.tellingmachine.com/post/Drawing-battleships-with-PowerShell-block-and-multi-line-comment-literals.aspx)
