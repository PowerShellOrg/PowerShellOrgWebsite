...
aliases:
  - /2022/03/chatting-about-chatbots-with-mike-kanakos-microsoft-mvp/
---
...
Mike is a Microsoft MVP who might be the biggest advocate for PowerShell out there. He has weekly engagements where he is blogging or talking about Powershell. He is so active in the community they figured they might as well make him the Director of Community Engagement at [PowerShell.org][2]. He also leads the Research Triangle PowerShell Users Group, which is helping over 2400 members better automate with PowerShell.
...
Poshbot Git - [GitHub - poshbotio/PoshBot: Powershell-based bot framework][3]

Poshbot Docs - [Home - PoshBot Docs][4]

pscookiemonster on Poshbot - <http://ramblingcookiemonster.github.io/PoshBot/>

Using Webhooks - [Get a Teams Notification the Moment an Active Directory User gets Locked Out with PowerShell Using Webhooks – The Lazy Administrator][5]

 [1]: https://mcdn.podbean.com/mf/web/vx87gi/PowerShell_Podcast_episode_4aglii.mp3
 [2]: https://PowerShell.org
 [3]: https://github.com/poshbotio/PoshBot
 [4]: https://poshbot.readthedocs.io/en/latest/
 [5]: https://www.thelazyadministrator.com/2018/12/13/get-a-teams-notification-the-moment-an-active-directory-user-gets-locked-out-with-powershell-using-webhooks/
