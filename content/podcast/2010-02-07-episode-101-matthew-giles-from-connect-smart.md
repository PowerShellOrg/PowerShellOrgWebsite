...
podcast_url: "http://media.libsyn.com/media/powerscripting/PSPodcast-101.mp3"
aliases:
  - /2010/02/episode-101-matthew-giles-from-connect-smart/
---
...
Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://media.libsyn.com/media/powerscripting/PSPodcast-101.mp3)
...
Tonight on the PowerScripting Podcast we talk to Matthew Giles from Connect-SMART
...
Resources
        ...
        - 
          [Troubleshooting PowerShell remoting](http://technet.microsoft.com/en-us/library/dd347642.aspx)


        - 
          [Working with recovery points in Data Protection Manager](http://blogs.technet.com/dpm/archive/2010/02/04/how-to-create-and-delete-recovery-points-for-dpm-via-powershell.aspx?utm_source=twitterfeed&utm_medium=twitter)


        - 
          [](http://technet.microsoft.com/en-us/library/dd347642.aspx)[Get the users that have logged on to a computer with PowerShell](http://outputredirection.blogspot.com/2010/02/get-users-that-have-logged-on-to.html?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed:+OutputRedirection+(Output+Redirection+(Atom)))


        - 
          [Who's logged into which VM?](http://virtualisedreality.wordpress.com/2010/01/24/powershell-scipt-for-vmware-view-vsphere-who-is-logged-into-which-vm/)


        - 
          [Retrieve .NET versions installed on remote systems](http://poshcode.org/1628)
...
Our tips are brought to you today by ServerFault and StackOverflow, the best place to find answers to your toughest questions!
              ...
              - 
                [Changing the Execution Policy Without Admin Rights](http://powershell.com/cs/blogs/tips/archive/2010/02/04/changing-execution-policy-without-admin-rights.aspx)


              - 
                [You can dot-source more than scripts](http://blairconrad.wordpress.com/2010/01/29/expand-your-scope-you-can-dot-source-more-than-just-files/)
