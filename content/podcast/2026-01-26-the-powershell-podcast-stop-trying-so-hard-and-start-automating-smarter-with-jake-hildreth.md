...
Principal Security Consultant and community favorite Jake Hildreth returns to _The PowerShell Podcast_ to talk about building smarter automation, leveling up through community, and creating tools that solve real problems. Andrew shares his “stop trying so hard” theme for the year, how working smarter applies directly to scripting and security, and why getting involved with others is one of the fastest ways to grow in your career.
...
Resource Links:  
• Jake Hildreth’s Website – [https://jakehildreth.com][2]  
...
• PowerShell Conference Europe – [https://psconf.eu][3]  
• PowerShell + DevOps Global Summit – [https://powershellsummit.org][4]  
...
The PowerShell Podcast on YouTube: <https://youtu.be/rFeoTKLerkA>
 ...
 [1]: https://mcdn.podbean.com/mf/web/ffg9evy96mt9pgat/The_PowerShell_Podcast_episode_211_Jake_Hildreth8k827.mp3
 [2]: https://jakehildreth.com/
 [3]: https://psconf.eu/
 [4]: https://powershellsummit.org/
