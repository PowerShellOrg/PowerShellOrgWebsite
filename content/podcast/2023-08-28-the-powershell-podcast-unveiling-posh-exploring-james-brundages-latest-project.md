...
The [MSAL.PS][3] PowerShell module wraps [MSAL.NET][4] functionality into PowerShell-friendly cmdlets and is not supported by Microsoft. Microsoft support does not extend beyond the underlying [MSAL.NET][4] library. For any inquiries regarding the PowerShell module itself, you may contact the author on GitHub or PowerShell Gallery.

[MSAL.NET][4] (Microsoft.Identity.Client) is an authentication library that enables you to acquire tokens from Azure AD, to access protected Web APIs (Microsoft APIs or applications registered with Azure Active Directory).

 [1]: https://mcdn.podbean.com/mf/web/7zdf9n/The_PowerShell_Podcast_episode_80_James_B8las0.mp3
 [2]: https://www.powershellgallery.com/packages/MSAL.PS/
 [3]: http://msal.ps/
 [4]: http://msal.net/
