...
podcast_url: "http://media.libsyn.com/media/powerscripting/PSPodcast-099.mp3"
aliases:
  - /2010/02/episode-99-shannon-ma-on-configuration-management/
---
...
Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://media.libsyn.com/media/powerscripting/PSPodcast-099.mp3)
...
Tonight on the PowerScripting Podcast we talk to Shannon Ma about configuration management
...
Resources
        ...
        - 
          [Adding/Removing members from another forest/domain to groups in AD](http://blogs.msdn.com/adpowershell/archive/2010/01/20/adding-removing-members-from-another-forest-or-domain-to-groups-in-active-directory.aspx)


        - 
          [Update Linux VMs with PowerCLI](http://ict-freak.nl/2010/01/20/update-linux-vms-with-powercli-thanks-to-invoke-vmscript/?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed:+Ict-freak+(ICT-Freak))
