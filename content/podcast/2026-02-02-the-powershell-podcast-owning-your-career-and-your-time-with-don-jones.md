...
Guest Bio:  
Don Jones is a foundational figure in the PowerShell community, known for his decades of teaching, writing, and advocacy for automation and professional growth. A former Microsoft MVP, Don co-authored the widely influential _Learn PowerShell in a Month of Lunches_ series and helped shape community culture through conferences, mentorship, and leadership. Now retired from full-time work, Don continues writing and publishing fiction, bringing the same clarity and craft to storytelling that made his technical teaching so impactful.  

Resource Links:  
• Don Jones Website and Books – [[https://donjones.com](https://donjones.com)][2] 

Andrew's links: <https://andrewpla.tech/links>

• PowerShell + DevOps Global Summit – [https://powershellsummit.org][3]  
• Tech Impact (nonprofit mentioned) – [https://techimpact.org][4]  
• [PowerShell.org][5] – [https://powershell.org][6]  
...
The PowerShell Podcast on YouTube: <https://youtu.be/xKh8rqCqMQg>
 ...
 [1]: https://mcdn.podbean.com/mf/web/h7uxvzfjr22gitma/The_PowerShell_Podcast_episode_212_Don_Jones8e38f.mp3
 [2]: https://donjones.com/
 [3]: https://powershellsummit.org/
 [4]: https://techimpact.org/
 [5]: http://powershell.org/
 [6]: https://powershell.org/
