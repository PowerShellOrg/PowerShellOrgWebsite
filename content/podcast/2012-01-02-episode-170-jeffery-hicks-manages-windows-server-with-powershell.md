...
podcast_url: "http://traffic.libsyn.com/powerscripting/PSPodcast-170.mp3"
aliases:
  - /2012/01/episode-170-jeffery-hicks-manages-windows-server-with-powershell/
---
...
**A Podcast about Windows PowerShell.**
 Listen:
  ...
  [**![](http://powerscripting.libsyn.com/img/podcastIcon.gif)**](http://traffic.libsyn.com/powerscripting/PSPodcast-170.mp3)
...
#### 
    ...
    - 
        ...
        TrainSignal Videos:
            ...
            [PowerShell Fundamentals](http://www.trainsignal.com/Windows-PowerShell-Training.aspx)
        ...
        - 
            ...
            [Managing Windows Server](http://www.trainsignal.com/Windows-Server-2008-PowerShell-Training.aspx)
    ...
    - 
        ...
        Jeff"™s Deep Dive: [Turning CLI Tools into PowerShell Tools Deep Dive Demos](http://jdhitsolutions.com/blog/2011/10/turning-cli-tools-into-powershell-tools-deep-dive-demos/)
 ...
 **
    ...
    [21:53:42]  ##Can you explain CIM more





    [21:56:00]  ####What kind of wine Don?





    [21:57:34]  If you are seeing Don Jones you are watching last weeks show and not the live feed





    [21:58:12]  that goofy little red live button is hard to find sometimes





    [21:58:47]  time travel is not only expensive, but dangerous.





    [22:06:19]  ###These are available for Server core right?





    [22:12:39]  ###What is Jeff drinking? Captain Morgan? 🙂





    [22:13:20]  [21:02:42]  back. Tonight's PowerShell musings brought to you by Fuller's London Porter
 ...
 **
 ...
 Resources**
    ...
    - 
        ...
        Jeff Hicks wrote a multipurpose script to [convert text output to objects](http://jdhitsolutions.com/blog/2011/10/convert-text-to-object/)
    ...
    - 
        ...
        From Josh Atwell, "[Y U No vMotion](http://www.vtesseract.com/post/14568101265/y-u-no-vmotion)?"
            ...
            [and his guest post on The Scripting Guy Blog on using PowerCLI](http://blogs.technet.com/b/heyscriptingguy/archive/2011/12/16/use-powershell-to-simplify-access-to-data-through-powercli.aspx)
    ...
    - 
        ...
        [Playing Music with PowerShell](http://rakasatria.wordpress.com/2011/12/11/playing-music-with-powershell/)
    ...
    - 
        ...
        MVP Scott Moss is blogging about [SCOM 2012 PowerShell](http://om2012.wordpress.com/category/om12-powershell/)
    ...
    - 
        ...
        [RDS PowerShell TFM](http://msviennatechnoblog.wordpress.com/2011/12/02/rds-powershell-tfm-8-steps-to-automate-your-remote-desktop-services-infrastructure-using-powershell/)
 ...
 Tips**
    ...
    - 
        ...
        [Hal discusses working with large sets of files and break them into manageable groups](https://plus.google.com/u/0/106423422372421380780/posts/5MvTGp8gqcN)
